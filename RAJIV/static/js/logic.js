...
////////TO CREATE THE MARKERS/// Loop through the Markers (city) array.
    for (let index = 0; index < rentData.length; index++) {
        let curr = rentData[index]
    // For each station, create a marker, and bind a popup with the station's name.
        let zipMarker = L.marker([curr.latitudes, curr.longitudes])
        .bindPopup("<h3>" + curr.city + 
        "<h3><h3>Population: " + curr.population + 
        "<h3><h3>Median Sale Price: " + curr.medianprice +
        "<h3><h3>Median Monthly Rent Price: " + curr.avgprice +
        "<h3><h3>Price to Rent Ratio: " + curr.ratio +
        "<h3>")
